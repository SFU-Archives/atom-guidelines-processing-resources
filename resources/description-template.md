...
# Archival Description Template and Boilerplate Text

This page contains boilerplate text for fields commonly used in fonds- and series-level descriptions in SFU AtoM. For more detailed guidance, see the [Archival Description Data Entry Guidelines](../archival-description/overview.md).

## Title note
`Source of title proper` – Title supplied by the archivist based on the contents of the LEVEL.
...
**Notes:**
- If transcribing the `Title` from a file or item, no title note is needed.
- At the **file-** and **item** level, do not use square brackets – explain **supplied** titles in a `Title note`.

## Dates
`Creation:` 1965-1972

`Dates of document:` 1955-1972

**Note:**
- Use `Creation` date for dates of accumulation.
- Use `Dates of document` only if the dates of individual documents are earlier than the dates accumulated.
- If using `Dates of document`, explain in the `Date note` field.

## Physical description
Paper and analog originals:<br/>
1.25 m of textual records and other materials

Born-digital materials:<br/>
...
**Note:**
- In hybrid (analog-digital) fonds, include separate entries for analog, born-digital, and digitized.
...
For university departments, prepare the [Admin History Data template](../downloads/admin-history-data-template.zip) as a [finding aid appendix](finding-aid-appendices.md).
...
**Note:**
- Digital records: discuss here relevant data migrations, export, conversions, corruptions.
...
**Notes:**
- When possible, provide descriptions at all **series** level (i.e. series, sub- and sub-sub-series).
- Only include **file** and **item** level descriptions in exceptional circumstances.

## Arrangement
Use only when a fuller explanation of the arrangement is useful; otherwise just use a simple statement in Scope and content.
...
Describes materials at other institutions.
